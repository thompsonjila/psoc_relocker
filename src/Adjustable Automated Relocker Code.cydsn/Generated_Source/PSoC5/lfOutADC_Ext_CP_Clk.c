/*******************************************************************************
* File Name: LFOutADC_Ext_CP_Clk.c
* Version 2.20
*
*  Description:
...
/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_Start(void) 
{
    /* Set the bit to enable the clock. */
    LFOutADC_Ext_CP_Clk_CLKEN |= LFOutADC_Ext_CP_Clk_CLKEN_MASK;
	LFOutADC_Ext_CP_Clk_CLKSTBY |= LFOutADC_Ext_CP_Clk_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    LFOutADC_Ext_CP_Clk_CLKEN &= (uint8)(~LFOutADC_Ext_CP_Clk_CLKEN_MASK);
	LFOutADC_Ext_CP_Clk_CLKSTBY &= (uint8)(~LFOutADC_Ext_CP_Clk_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_StopBlock(void) 
{
    if ((LFOutADC_Ext_CP_Clk_CLKEN & LFOutADC_Ext_CP_Clk_CLKEN_MASK) != 0u)
    {
...
#if defined(LFOutADC_Ext_CP_Clk__CFG3)
        CLK_DIST_AMASK = LFOutADC_Ext_CP_Clk_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = LFOutADC_Ext_CP_Clk_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* LFOutADC_Ext_CP_Clk__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(LFOutADC_Ext_CP_Clk_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(LFOutADC_Ext_CP_Clk_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        LFOutADC_Ext_CP_Clk_CLKSTBY &= (uint8)(~LFOutADC_Ext_CP_Clk_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = LFOutADC_Ext_CP_Clk_GetSourceRegister();
    uint16 oldDivider = LFOutADC_Ext_CP_Clk_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = LFOutADC_Ext_CP_Clk_CLKEN & LFOutADC_Ext_CP_Clk_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(LFOutADC_Ext_CP_Clk_DIV_PTR, clkDivider);
                LFOutADC_Ext_CP_Clk_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                LFOutADC_Ext_CP_Clk_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(LFOutADC_Ext_CP_Clk_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((LFOutADC_Ext_CP_Clk_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(LFOutADC_Ext_CP_Clk_DIV_PTR, clkDivider);
				LFOutADC_Ext_CP_Clk_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 LFOutADC_Ext_CP_Clk_GetDividerRegister(void) 
{
    return CY_GET_REG16(LFOutADC_Ext_CP_Clk_DIV_PTR);
}


/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_SetModeRegister(uint8 modeBitMask) 
{
    LFOutADC_Ext_CP_Clk_MOD_SRC |= modeBitMask & (uint8)LFOutADC_Ext_CP_Clk_MODE_MASK;
}


/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_ClearModeRegister(uint8 modeBitMask) 
{
    LFOutADC_Ext_CP_Clk_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(LFOutADC_Ext_CP_Clk_MODE_MASK));
}


/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 LFOutADC_Ext_CP_Clk_GetModeRegister(void) 
{
    return LFOutADC_Ext_CP_Clk_MOD_SRC & (uint8)(LFOutADC_Ext_CP_Clk_MODE_MASK);
}


/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = LFOutADC_Ext_CP_Clk_GetDividerRegister();
    uint8 oldSrc = LFOutADC_Ext_CP_Clk_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        LFOutADC_Ext_CP_Clk_MOD_SRC |= CYCLK_SSS;
        LFOutADC_Ext_CP_Clk_MOD_SRC =
            (LFOutADC_Ext_CP_Clk_MOD_SRC & (uint8)(~LFOutADC_Ext_CP_Clk_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 LFOutADC_Ext_CP_Clk_GetSourceRegister(void) 
{
    return LFOutADC_Ext_CP_Clk_MOD_SRC & LFOutADC_Ext_CP_Clk_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void LFOutADC_Ext_CP_Clk_SetPhaseRegister(uint8 clkPhase) 
{
    LFOutADC_Ext_CP_Clk_PHASE = clkPhase & LFOutADC_Ext_CP_Clk_PHASE_MASK;
}


/*******************************************************************************
* Function Name: LFOutADC_Ext_CP_Clk_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 LFOutADC_Ext_CP_Clk_GetPhaseRegister(void) 
{
    return LFOutADC_Ext_CP_Clk_PHASE & LFOutADC_Ext_CP_Clk_PHASE_MASK;
}
