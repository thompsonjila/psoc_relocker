...
{
    uint8 staticBits = (vdd_DR & (uint8)(~vdd_MASK));
    vdd_DR = staticBits | ((uint8)(value << vdd_SHIFT) & vdd_MASK);
}
...
{
	CyPins_SetPinDriveMode(vdd_0, mode);
}
...
uint8 vdd_Read(void)
{
    return (vdd_PS & vdd_MASK) >> vdd_SHIFT;
}
...
{
    return (vdd_DR & vdd_MASK) >> vdd_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & vdd_0_INTR) != 0u) 
		{ 
			 vdd_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (vdd_INTSTAT & vdd_MASK) >> vdd_SHIFT;
    }
