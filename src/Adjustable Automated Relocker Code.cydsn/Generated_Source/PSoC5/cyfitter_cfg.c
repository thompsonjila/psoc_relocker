...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480000CCu)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x480000D4u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT0_AMUX, 0x0A40u);
...
uint8 CYXDATA * const CYCODE LFOutADC_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE LFOutADC_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: LFOutADC_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void LFOutADC_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*LFOutADC_AMux__addrTable[channel] |= LFOutADC_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: LFOutADC_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void LFOutADC_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*LFOutADC_AMux__addrTable[channel] &= (uint8)~LFOutADC_AMux__maskTable[channel];
	}
}
